...
#ifndef __INTERFLOP_CUSTOM_H
#define __INTERFLOP_CUSTOM_H
...
extern "C" {
#endif
#define IFCUSTOM_FCTNAME(FCT) interflop_custom_##FCT
...
#include "../interflop.h"
  ...
  typedef struct custom_conf custom_conf_t;


  void IFCUSTOM_FCTNAME(configure)(custom_conf_t mode,void* context);
  void IFCUSTOM_FCTNAME(finalize)(void* context);

  const char* IFCUSTOM_FCTNAME(get_backend_call_name)(void);
  const char* IFCUSTOM_FCTNAME(get_backend_version)(void);

  void custom_set_denorm_handler(void (*)(void));

  extern void (*vr_panicHandler)(const char*);
  void custom_set_panic_handler(void (*)(const char*));
  ...
  void IFCUSTOM_FCTNAME(cast_double_to_float) (double a, float* b, void* context);
...
#endif /* ndef __INTERFLOP_CUSTOM_H */